...
Frieze pattern 2 (translation & glide reflection)
"""
...
stim.positions.SetPositionDeviations(element_id = list(range(n_translations,2*n_translations)), x_offset = -basewidth/2)
