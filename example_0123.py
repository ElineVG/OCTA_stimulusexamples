...
stim.shapes = GridPattern.MirrorAcrossElements( [ Image("svg/example_0122.svg"), None ] )

# Add orientations for the elements
stim.orientations = GridPattern.RepeatAcrossElements( [ 0, 0, 0, 180 ] )
