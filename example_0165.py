...
stimname = "example_0165"

# Define stimulus
stim = Outline(n_elements = 24, x_margin = 0, y_margin = 0, shape_boundingbox = (100,100), background_color = "none", 
...
stim.orientations = GridPattern.RepeatAcrossElements( [ ['animate', '360', '0', "dur='20s', repeatCount='indefinite'"] ] )
