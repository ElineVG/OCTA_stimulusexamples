...
stim.shapes = GridPattern.RepeatAcrossRows( [ Rectangle, Ellipse, Triangle ] )

# Add fillcolors for the elements
stim.fillcolors = GridPattern.RepeatAcrossRows( [ "#6dd6ff", "#1b9fd8", "#006ca1" ] )
