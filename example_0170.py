...
stim.shapes = GridPattern.RepeatAcrossElements( [ Image('svg/example_0156.svg'),  Image('svg/example_0154.svg'), 
                                                  Image('svg/example_0155.svg') ] )
