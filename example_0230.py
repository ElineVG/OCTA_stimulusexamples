...
Example stimulus 230
created by Eline Van Geert

Wallpaper patterns: PMG
"""
...
stim.mirrorvalues = GridPattern.TiledGrid(GridPattern.RepeatAcrossElements(["none", "horizontalvertical", "horizontal", "vertical"],2,2),4)
