...
Example stimulus 231
created by Eline Van Geert

Wallpaper patterns: PGG
"""
...
stim.mirrorvalues = GridPattern.TiledGrid(GridPattern.RepeatAcrossElements(["none", "horizontalvertical", "vertical", "horizontal"],2,2),4)
