...
stim.shapes = GridPattern.RepeatAcrossElements( [ Image('svg/example_0140.svg'),  Image('svg/example_0142.svg'), 
                                                  Image('svg/example_0141.svg'),  Image('svg/example_0143.svg') ] )
