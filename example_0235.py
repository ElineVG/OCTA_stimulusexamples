...
Example stimulus 235
created by Eline Van Geert

Wallpaper patterns: P4G
"""
...
stimulus = Concentric(2, background_color = "none", size = basesize)
stimulus.shapes = GridPattern.RepeatAcrossElements([Image("svg/example_0220.svg")])
...
stim.mirrorvalues = GridPattern.TiledGrid(GridPattern.RepeatAcrossElements(["none", "horizontal", "vertical", "horizontalvertical"],2,2),4)
