...
Example stimulus 236
created by Eline Van Geert

Wallpaper patterns: P3
"""
...
stimname = "example_0236"

# Define template parameters
baseshape = Image("svg/example_0218.svg")
basesize = (100,100)
basewidth = basesize[0]
baseheight = basesize[1]

# Create template tile
stimulus = Concentric(n_elements = 3, background_color = "none", size = (400,400))
stimulus.shapes = GridPattern.RepeatAcrossElements([baseshape])
stimulus.boundingboxes = GridPattern.RepeatAcrossElements([(400,400*np.sqrt(3))])
