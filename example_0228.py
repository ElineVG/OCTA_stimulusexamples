...
Example stimulus 228
created by Eline Van Geert

Wallpaper patterns: CM
"""
...
stim.mirrorvalues = GridPattern.TiledGrid(GridPattern.RepeatAcrossElements(["none", "horizontal", "horizontal", "none"],2,2),4)
