...
stim.shapes = GridPattern.RepeatAcrossElements( [ Image('svg/example_0128.svg'),  Image('svg/example_0129.svg'), 
                                                  Image('svg/example_0127.svg') ] )
