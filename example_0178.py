...
stim.shapes = GridPattern.RepeatAcrossElements( [ Image('svg/example_0150.svg'),  Image('svg/example_0151.svg'), 
                                                  Image('svg/example_0152.svg'),  Image('svg/example_0153.svg') ] )
